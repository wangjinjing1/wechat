package com.luisa.wechat.chat.controller;
...
public class ChatController {
    ...
    public BootstrapView bootstrap(Authentication authentication) {
        return chatService.bootstrap(authentication.getName());
    }

    @GetMapping("/sidebar/conversations")
    public PagedResult<ConversationSummary> listConversations(
    ...
    public PagedResult<UserSummary> listUsers(
            @RequestParam(value = "keyword", required = false) String keyword,
            @RequestParam(value = "page", required = false) Integer page,
            @RequestParam(value = "size", required = false) Integer size,
            Authentication authentication) {
    ...
    public PagedResult<FriendRequestView> listFriendRequests(
            @RequestParam(value = "keyword", required = false) String keyword,
            @RequestParam(value = "page", required = false) Integer page,
            @RequestParam(value = "size", required = false) Integer size,
            Authentication authentication) {
    ...
    public UserSummary updateFriendRemark(@PathVariable("username") String username,
    ...
    public GroupSummary createGroup(@RequestBody GroupRequest request, Authentication authentication) {
        return chatService.createGroup(authentication.getName(), request.name(), request.memberUsernames());
    }

    @PostMapping("/groups/{groupId}/members")
    public GroupSummary addGroupMember(@PathVariable("groupId") Long groupId,
    ...
    public PagedResult<GroupMemberView> listGroupMembers(
    ...
    public GroupSummary removeGroupMember(@PathVariable("groupId") Long groupId,
    ...
    public UserProfile updateAvatar(@RequestParam("file") MultipartFile file, Authentication authentication) {
        return chatService.updateAvatar(authentication.getName(), file);
    }

    @GetMapping("/conversations/lobby/messages")
    public MessagePage lobbyMessages(@RequestParam(value = "beforeId", required = false) Long beforeId,
                                                 Authentication authentication) {
    ...
    @ResponseStatus(HttpStatus.CREATED)
    public MessageView sendLobbyMessage(@RequestBody MessageRequest request, Authentication authentication) {
    ...
    @ResponseStatus(HttpStatus.CREATED)
    public MessageView sendLobbyFile(@RequestParam("file") MultipartFile file, Authentication authentication) {
        return chatService.sendLobbyFile(authentication.getName(), file);
    }

    @GetMapping("/conversations/direct/{username}/messages")
    public MessagePage directMessages(@PathVariable("username") String username,
    ...
    @ResponseStatus(HttpStatus.CREATED)
    public MessageView sendDirectMessage(@PathVariable("username") String username,
    ...
    @ResponseStatus(HttpStatus.CREATED)
    public MessageView sendDirectFile(@PathVariable("username") String username,
    ...
    public MessagePage groupMessages(@PathVariable("groupId") Long groupId,
                                                 @RequestParam(value = "beforeId", required = false) Long beforeId,
                                                 Authentication authentication) {
    ...
    @ResponseStatus(HttpStatus.CREATED)
    public MessageView sendGroupMessage(@PathVariable("groupId") Long groupId,
                                                    @RequestBody MessageRequest request,
                                                    Authentication authentication) {
    ...
    @ResponseStatus(HttpStatus.CREATED)
    public MessageView sendGroupFile(@PathVariable("groupId") Long groupId,
                                                 @RequestParam("file") MultipartFile file,
                                                 Authentication authentication) {
