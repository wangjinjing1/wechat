...
public class GlobalExceptionHandler {
    ...
    public Map<String, Object> handleChat(ChatService.ChatException ex) {
        return error(HttpStatus.BAD_REQUEST, ex.getMessage());
    }

    @ExceptionHandler(ChatService.UnauthorizedException.class)
    @ResponseStatus(HttpStatus.UNAUTHORIZED)
    public Map<String, Object> handleUnauthorized(ChatService.UnauthorizedException ex) {
